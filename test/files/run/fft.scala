 ...
 */
object Test  {
  val boxes = scala.runtime.BoxesRunTime.instrument()
...
//    println("[loaded]")
  ...
  def main(args: Array[String]) {
    ...
    println("Boxed doubles: " + boxes.doubleBoxCount)
    println("Boxed ints: " + boxes.integerBoxCount)
    println("Boxed longs: " + boxes.longBoxCount)
  }
}
