...
// ------------ Phases -------------------------------------------}
  ...
  def newSourceFile(code: String, filename: String = "<console>") = new BatchSourceFile(filename, code)
  def newCompilationUnit(code: String, filename: String = "<console>") = CompilationUnit(newSourceFile(code, filename))
