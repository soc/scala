...
// import scala.tools.nsc.util.{ ClassPath, JavaClassPath, ScalaClassLoader, ClassPath, ClassRep }
...
//   // called from scalap
//   def fromPathString(path: String, context: JavaContext = DefaultJavaContext): ClassPath = {
//     val s = new Settings()
//     s.classpath.value = path
//     new Resolver(s, context) result
//   }
...
// // class Resolver(settings: Settings, context: JavaContext) {
// //   import Resolver.{ Defaults, Environment, AsLines, MkLines, ppcp }
...
// //       Console print s"Defaults: ${Resolver.Defaults}"
