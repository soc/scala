...
trait Definitions extends api.StandardDefinitions {
  ...
  trait ValueClassDefinitions {
    ...
    def isNumericValueClass(sym: Symbol) = sym.isNumericValueClass
  ...
  // A type function from T => Class[U], used to determine the return
    ...
    def isPrimitiveValueClass(sym: Symbol) = sym.isPrimitiveValueClass
    def isPrimitiveValueType(tp: Type)     = tp.typeSymbol.isPrimitiveValueClass
