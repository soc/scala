...
// ------ toString -------------------------------------------------------------------
    ...
    private def symbolKind: SymbolKind = {
      var kind =
        ...
        else if (isExistentialSkolem) ("existential skolem", "type", "ESKOLEM")
        else if (isExistentiallyBound) ("existential tparam", "type", "ETPARAM")
        else if (isTypeParameter) ("tparam", "type", "TPARAM")
        else if (isTypeSkolem) ("type skolem", "type", "SKOLEM")
