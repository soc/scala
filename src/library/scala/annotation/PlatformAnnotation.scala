...
sealed abstract class PlatformAnnotation extends ConstantAnnotation with java.lang.annotation.Annotation {
  def annotationType: Class[_ <: java.lang.annotation.Annotation] = ??? // FIXME
}
